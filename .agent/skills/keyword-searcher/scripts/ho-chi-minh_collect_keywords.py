...
DESTINATION = DestinationConfig(
    ...
    name_variants=[
        "hồ chí minh", "ho chi minh", "hcm", "hcmc", 
    ...
    entities=[
        "bến thành", "chợ lớn", "suối tiên", "đầm sen", "landmark 81", 
        "phố đi bộ nguyễn huệ", "phố tây bùi viện", "dinh độc lập", 
        "địa đạo củ chi", "cần giờ", "phố đi bộ", "bảo tàng chứng tích", 
        "nhà thờ đức bà", "bưu điện thành phố"
    ],

    districts=[
        "quận 1", "quận 2", "quận 3", "quận 4", "quận 5", "quận 6", "quận 7", "quận 8", 
        "quận 9", "quận 10", "quận 11", "quận 12", "bình thạnh", "phú nhuận", "gò vấp", 
        "tân bình", "tân phú", "bình tân", "nhà bè", "hóc môn", "củ chi", "cần giờ", 
        "bình chánh", "thủ đức"
    ],

    landmark_keywords=[
        "ben thanh", "cho lon", "suoi tien", "dam sen", "landmark 81", 
        "nguyen hue", "bui vien", "dinh doc lap", "cu chi", "can gio", "pho di bo", 
        "bao tang chung tich", "nha tho duc ba", "buu dien"
    ],

    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(ben thanh)", "name": "Chợ Bến Thành"},
            {"pattern": r"(cho lon)", "name": "Chợ Lớn"},
            {"pattern": r"(landmark 81)", "name": "Landmark 81"},
            {"pattern": r"(dinh doc lap)", "name": "Dinh Độc Lập"},
            {"pattern": r"(cu chi)", "name": "Địa đạo Củ Chi"},
            {"pattern": r"(can gio)", "name": "Cần Giờ"},
            {"pattern": r"(nha tho duc ba)", "name": "Nhà thờ Đức Bà"},
            {"pattern": r"(buu dien)", "name": "Bưu điện Thành phố"},
            {"pattern": r"(pho di bo|nguyen hue|bui vien)", "name": "Phố đi bộ HCM"},
        ],
        "Lưu trú": [
            {"pattern": r"(\\b5 sao\\b|5 sao)", "name": "Khách sạn 5 sao Hồ Chí Minh"},
            {"pattern": r"(\\b4 sao\\b|4 sao)", "name": "Khách sạn 4 sao Hồ Chí Minh"},
            {"pattern": r"(\\b3 sao\\b|3 sao)", "name": "Khách sạn 3 sao Hồ Chí Minh"},
            {"pattern": r"(quan 1)", "name": "Khách sạn Quận 1"},
        ],
        "Di chuyển": [
            {"pattern": r"(san bay|airport|tan son nhat)", "name": "Sân bay Tân Sơn Nhất"},
            {"pattern": r"(ben xe|mien dong|mien tay)", "name": "Bến xe Hồ Chí Minh"},
            {"pattern": r"\\btour\\b", "name": "Tour Hồ Chí Minh"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(com tam|cơm tấm)", "name": "Cơm tấm Sài Gòn"},
            {"pattern": r"(banh mi|bánh mì)", "name": "Bánh mì Sài Gòn"},
            {"pattern": r"(oc|ốc)", "name": "Ốc Sài Gòn"},
            {"pattern": r"(an vat|ăn vặt)", "name": "Ăn vặt Sài Gòn"},
        ],
    },
...
def build_candidates():
    ...
    # Group B1: Từ Google Planner (ưu tiên)
    ...
    # Group B2: từ SEO Insider (opportunity) – lọc travelish, KD thấp, volume đủ
    ...
    # Group B3: từ Google Trend – lọc travelish + destination-ish
