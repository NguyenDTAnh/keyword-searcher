...
DESTINATION = DestinationConfig(
    ...
    entities=[
        "hồ xuân hương", "langbiang", "lang biang", "thung lũng tình yêu", "đường hầm điêu khắc",
        "hồ tuyền lâm", "chợ âm phủ", "ga đà lạt", "vườn hoa đà lạt", "dinh bảo đại",
        "thiền viện trúc lâm", "chùa linh phước", "thác datanla", "thác dantanla", "thác pongour",
        "thác pren", "cây thông cô đơn", "đồi chè cầu đất"
    ],
    districts=[
    ],
    landmark_keywords=[
        "ho xuan huong", "langbiang", "lang biang", "thung lung tinh yeu", "ho tuyen lam", 
        "ga da lat", "dinh bao dai", "thien vien truc lam", "chua linh phuoc", 
        "thac dantanla", "thac datanla", "thac pongour", "doi che cau dat"
    ],
    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(ho xuan huong)", "name": "Hồ Xuân Hương"},
            {"pattern": r"(langbiang|lang biang)", "name": "Đỉnh Langbiang"},
            {"pattern": r"(thung lung tinh yeu)", "name": "Thung Lũng Tình Yêu"},
            {"pattern": r"(ho tuyen lam)", "name": "Hồ Tuyền Lâm"},
        ],
        "Lưu trú": [
            {"pattern": r"(homestay|hostel)", "name": "Homestay Đà Lạt"},
            {"pattern": r"(\\b4 sao\\b|4 sao)", "name": "Khách sạn 4 sao Đà Lạt"},
            {"pattern": r"(\\b5 sao\\b|5 sao)", "name": "Khách sạn 5 sao Đà Lạt"},
            {"pattern": r"(villa|biet thu)", "name": "Villa Đà Lạt"},
            {"pattern": r"(resort)", "name": "Resort Đà Lạt"},
        ],
        "Di chuyển": [
            {"pattern": r"(san bay lien khuong|airport)", "name": "Sân bay Liên Khương & di chuyển"},
            {"pattern": r"\\btour\\b", "name": "Tour Đà Lạt"},
            {"pattern": r"(xe |limousine)", "name": "Xe đi Đà Lạt"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(banh trang nuong)", "name": "Bánh tráng nướng Đà Lạt"},
            {"pattern": r"(nem nuong)", "name": "Nem nướng Đà Lạt"},
            {"pattern": r"(lau ga la e|lau bo ba toa)", "name": "Lẩu Đà Lạt"},
            {"pattern": r"(cafe|ca phe|coffee)", "name": "Quán cafe Đà Lạt"},
        ],
    },
    ...
    extra_travel_patterns="|hoa|vuon|thac|ho|suoi",
)
...
def build_candidates():
    ...
    for kw_n, p in planner_data.items():
        ...
        score = base_score * comp_factor * bonus_multiplier * 50.0 # B ưu tiên sử dụng keyword từ google planner
