...
DESTINATION = DestinationConfig(
    ...
    name_variants=[
        "tam đảo", "tam dao", "tamdao"
    ],

    entities=[
        "thác bạc", "tháp truyền hình", "nhà thờ đá", "cầu mây", "đỉnh rùng rình", "quán gió", "thiền viện trúc lâm", "tây thiên", "lâu đài tam đảo"
    ],

    districts=[
        "huyện tam đảo", "thị trấn tam đảo", "hợp châu", "đại đình", "tam quan"
    ],

    landmark_keywords=[
        "thac bac", "thap truyen hinh", "nha tho da", "cau may", "rung rinh", "quan gio", "thien vien", "truc lam", "tay thien", "lau dai"
    ],

    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(thac bac|thác bạc)", "name": "Thác Bạc Tam Đảo"},
            {"pattern": r"(thap truyen hinh|tháp truyền hình)", "name": "Tháp Truyền Hình Tam Đảo"},
            {"pattern": r"(nha tho da|nhà thờ đá)", "name": "Nhà Thờ Đá Tam Đảo"},
            {"pattern": r"(cau may|cầu mây)", "name": "Cầu Mây Tam Đảo"},
            {"pattern": r"(rung rinh|rùng rình)", "name": "Đỉnh Rùng Rình"},
            {"pattern": r"(thien vien|thiền viện|truc lam|trúc lâm|tay thien|tây thiên)", "name": "Thiền Viện Trúc Lâm Tây Thiên"},
            {"pattern": r"(lau dai|lâu đài)", "name": "Lâu Đài Tam Đảo"},
        ],
        "Lưu trú": [
            {"pattern": r"(\b4 sao\b|4 sao)", "name": "Khách sạn 4 sao Tam Đảo"},
            {"pattern": r"(\b5 sao\b|5 sao)", "name": "Khách sạn 5 sao Tam Đảo"},
            {"pattern": r"(homestay)", "name": "Homestay Tam Đảo"},
            {"pattern": r"(resort)", "name": "Resort Tam Đảo"},
            {"pattern": r"(villa)", "name": "Villa Tam Đảo"},
            {"pattern": r"(nha nghi)", "name": "Nhà nghỉ Tam Đảo"},
        ],
        "Di chuyển": [
            {"pattern": r"(limousine)", "name": "Xe Limousine đi Tam Đảo"},
            {"pattern": r"(xe khach|xe khách)", "name": "Xe khách đi Tam Đảo"},
            {"pattern": r"(xe buyt|bus|xe bus)", "name": "Xe buýt đi Tam Đảo"},
            {"pattern": r"(tour)", "name": "Tour Tam Đảo"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(ngon su|ngọn su)", "name": "Su su Tam Đảo"},
            {"pattern": r"(ga doi|gà đồi)", "name": "Gà đồi Tam Đảo"},
            {"pattern": r"(thit lon|thịt lợn|lon man|lợn mán)", "name": "Thịt lợn mán Tam Đảo"},
            {"pattern": r"(quan gio|quán gió)", "name": "Quán Gió Tam Đảo"},
            {"pattern": r"(dac san|đặc sản)", "name": "Đặc sản Tam Đảo"},
        ],
    },
