...
DESTINATION = DestinationConfig(
    ...
    entities=[
        "cồn phụng", "cồn thới sơn", "cồn quy", "sân chim vàm hồ", "cồn ốc", 
        "lan vương", "làng bè", "lăng nguyễn đình chiểu", "chợ lách", "cái mơn", 
        "cồn bửng", "biển thạnh phú", "làng yến", "phú an khang", "kdl"
    ],
    districts=[
        "ba tri", "bình đại", "châu thành", "chợ lách", "giồng trôm", 
        "mỏ cày bắc", "mỏ cày nam", "thạnh phú", "thành phố bến tre", "tp bến tre"
    ],
    landmark_keywords=[
        "con phung", "con thoi son", "con quy", "vam ho", "con oc", 
        "lan vuong", "lang be", "nguyen dinh chieu", "cho lach", "cai mon", 
        "con bung", "thanh phu", "lang yen", "phu an khang"
    ],
    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(con phung)", "name": "Cồn Phụng"},
            {"pattern": r"(con thoi son|thoi son)", "name": "Cồn Thới Sơn"},
            {"pattern": r"(con quy)", "name": "Cồn Quy"},
            {"pattern": r"(cho lach)", "name": "Làng hoa Chợ Lách"},
            {"pattern": r"(cai mon)", "name": "Làng mai Cái Mơn"},
            {"pattern": r"(lan vuong)", "name": "Khu du lịch Lan Vương"},
            {"pattern": r"(lang be)", "name": "Khu du lịch Làng Bè"},
            {"pattern": r"(lang yen)", "name": "Khu du lịch Làng Yến"},
            {"pattern": r"(phu an khang)", "name": "Khu du lịch Phú An Khang"},
            {"pattern": r"(nguyen dinh chieu)", "name": "Lăng Nguyễn Đình Chiểu"},
            {"pattern": r"(con bung|thanh phu)", "name": "Biển Thạnh Phú - Cồn Bửng"},
        ],
        "Lưu trú": [
            {"pattern": r"(\b4 sao\b)", "name": "Khách sạn 4 sao Bến Tre"},
            {"pattern": r"(\b5 sao\b)", "name": "Khách sạn 5 sao Bến Tre"},
            {"pattern": r"(resort)", "name": "Resort Bến Tre"},
            {"pattern": r"(homestay)", "name": "Homestay Bến Tre"},
        ],
        "Di chuyển": [
            {"pattern": r"(xe |taxi|limousine|dua don)", "name": "Xe đi Bến Tre"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(dua|kẹo dừa)", "name": "Đặc sản kẹo dừa Bến Tre"},
            {"pattern": r"(dac san)", "name": "Đặc sản Bến Tre"},
        ],
    },
    ...
    extra_travel_patterns="|kdl|miet vuon|trai cay"
)
