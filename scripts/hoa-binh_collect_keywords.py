...
DESTINATION = DestinationConfig(
    ...
    name_variants=[
        "hòa bình", "hoà bình", "hoa binh", "hoabinh"
    ],

    entities=[
        "thung nai", "mai châu", "kim bôi", "bản lác", "đèo thung khe", "thuỷ điện", "ba khan", "cửu thác tú sơn"
    ],

    districts=[
        "thành phố hòa bình", "thành phố hoà bình", "lương sơn", "cao phong", "đà bắc", "kỳ sơn", "lạc sơn", "lạc thủy", "lạc thuỷ", "mai châu", "tân lạc", "yên thủy", "yên thuỷ"
    ],

    landmark_keywords=[
        "thung nai", "thuy dien", "ban lac", "thung khe", "ba khan", "cuu thac tu son"
    ],

    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(thung nai)", "name": "Thung Nai"},
            {"pattern": r"(thuy dien)", "name": "Thuỷ điện Hoà Bình"},
            {"pattern": r"(ban lac)", "name": "Bản Lác"},
            {"pattern": r"(thung khe)", "name": "Đèo Thung Khe"},
            {"pattern": r"(ba khan)", "name": "Ba Khan"},
            {"pattern": r"(cuu thac tu son)", "name": "Cửu Thác Tú Sơn"},
        ],
        "Lưu trú": [
            {"pattern": r"(mai chau)", "name": "Lưu trú Mai Châu"},
            {"pattern": r"(kim boi)", "name": "Lưu trú Kim Bôi"},
        ],
        "Tổng hợp": [
            {"pattern": r"(suoi khoang|tam khoang)", "name": "Tắm khoáng Kim Bôi"},
        ]
    },
    ...
    extra_travel_patterns="|suoi khoang|nha san|tam khoang|ban cong",
)
