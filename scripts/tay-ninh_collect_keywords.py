...
DESTINATION = DestinationConfig(
    ...
    entities=[
        "núi bà đen", "nui ba den", "toà thánh", "tòa thánh", "hồ dầu tiếng", "ho dau tieng", "ma thiên lãnh", "lò gò xa mát", "chùa bà", "cửa khẩu mộc bài"
    ],

    districts=[
        "hòa thành", "trảng bàng", "tân biên", "tân châu", "dương minh châu", "châu thành", "bến cầu", "gò dầu"
    ],

    landmark_keywords=[
        "nui ba den", "toa thanh", "ho dau tieng", "ma thien lanh", "chua ba", "moc bai"
    ],

    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(nui ba den|\bba den\b|nui ba)", "name": "Núi Bà Đen"},
            {"pattern": r"(toa thanh)", "name": "Toà Thánh Tây Ninh"},
            {"pattern": r"(ho dau tieng)", "name": "Hồ Dầu Tiếng"},
        ],
        "Lưu trú": [
            {"pattern": r"(\\b5 sao\\b|5 sao)", "name": "Khách sạn 5 sao Tây Ninh"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(banh trang|\bmuoi\b|muoi tom|banh canh|trang bang)", "name": "Đặc sản Tây Ninh"},
            {"pattern": r"(bo to)", "name": "Bò tơ Tây Ninh"},
        ],
    },
