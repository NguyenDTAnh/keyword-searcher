...
DESTINATION = DestinationConfig(
    ...
    entities=[
        "mã pì lèng", "ma pi leng",
        "đồng văn", "dong van",
        "mèo vạc", "meo vac",
        "quản bạ", "quan ba",
        "hoàng su phì", "hoang su phi",
        "sông nho quế", "song nho que", "nho quế", "nho que",
        "cột cờ lũng cú", "cot co lung cu", "lũng cú", "lung cu",
        "dốc thẩm mã", "doc tham ma", "thẩm mã", "tham ma",
        "nhà của pao", "nha cua pao",
        "dinh thự họ vương", "dinh thu ho vuong", "dinh vua mèo", "dinh vua meo",
        "đèo mã pì lèng"
    ],

    districts=[
        "bắc mê", "bắc quang", "đồng văn", "hoàng su phì", 
        "mèo vạc", "quản bạ", "quang bình", "vị xuyên", 
        "xín mần", "yên minh"
    ],

    landmark_keywords=[
        "ma pi leng", "dong van", "meo vac", "quan ba", "hoang su phi", 
        "nho que", "lung cu", "tham ma", "nha cua pao", "dinh thu ho vuong", "dinh vua meo"
    ],

    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(ma pi leng)", "name": "Đèo Mã Pì Lèng"},
            {"pattern": r"(dong van)", "name": "Cao nguyên đá Đồng Văn"},
            {"pattern": r"(meo vac)", "name": "Mèo Vạc"},
            {"pattern": r"(quan ba)", "name": "Cổng trời Quản Bạ"},
            {"pattern": r"(hoang su phi)", "name": "Hoàng Su Phì"},
            {"pattern": r"(nho que)", "name": "Sông Nho Quế"},
            {"pattern": r"(lung cu)", "name": "Cột cờ Lũng Cú"},
            {"pattern": r"(tham ma)", "name": "Dốc Thẩm Mã"},
            {"pattern": r"(nha cua pao)", "name": "Nhà của Pao"},
        ...
        "Di chuyển": [
            {"pattern": r"(thue xe may|xe may)", "name": "Thuê xe máy Hà Giang"},
            {"pattern": r"(xe khach|limousine|giuong nam|cabin)", "name": "Xe khách đi Hà Giang"},
            {"pattern": r"\btour\b", "name": "Tour Hà Giang"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(thang co|thắng cố)", "name": "Thắng cố Hà Giang"},
            {"pattern": r"(men men|mèn mén)", "name": "Mèn mén Hà Giang"},
            {"pattern": r"(banh cuon|bánh cuốn)", "name": "Bánh cuốn trứng Hà Giang"},
        ],
    },
    ...
    extra_travel_patterns="|phuot|leo nui|tam giac mach",
)
