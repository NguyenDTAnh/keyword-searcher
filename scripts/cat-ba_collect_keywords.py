...
DESTINATION = DestinationConfig(
    ...
    entities=[
        "vịnh lan hạ", "vinh lan ha",
        "đảo khỉ", "dao khi",
        "rừng quốc gia", "vườn quốc gia",
        "hang quân y", "hang quan y",
        "động trung trang", "dong trung trang",
        "pháo đài thần công", "phao dai than cong",
        "bãi cát cò", "bai cat co",
        "cát cò 1", "cat co 1", "cát cò 2", "cát cò 3",
        "làng chài cái bèo", "cai beo", "bến bèo", "ben beo",
        "bến gót", "ben got"
    ],
    districts=[
        "cát hải", "cat hai"
    ...
    landmark_keywords=[
        "lan ha", "dao khi", "rung quoc gia", "vuon quoc gia",
        "hang quan y", "dong trung trang", "phao dai than cong",
        "cat co", "cai beo", "ben beo", "ben got", "tuan chau"
    ],
    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(lan ha)", "name": "Vịnh Lan Hạ"},
            {"pattern": r"(dao khi)", "name": "Đảo Khỉ"},
            {"pattern": r"(quoc gia)", "name": "Vườn quốc gia Cát Bà"},
            {"pattern": r"(quan y|trung trang)", "name": "Hang động Cát Bà"},
        ],
        "Lưu trú": [
            {"pattern": r"(resort|flamingo|mgallery)", "name": "Resort Cát Bà"},
            {"pattern": r"(\\b4 sao\\b)", "name": "Khách sạn 4 sao Cát Bà"},
            {"pattern": r"(\\b5 sao\\b)", "name": "Khách sạn 5 sao Cát Bà"},
            {"pattern": r"(homestay)", "name": "Homestay Cát Bà"},
        ],
        "Di chuyển": [
            {"pattern": r"(tau|pha|ferry|ben got|o to|xe khach|tuan chau)", "name": "Tàu phà đi Cát Bà"},
            {"pattern": r"(ca treo)", "name": "Cáp treo Cát Bà"},
            {"pattern": r"(xe may|thue xe)", "name": "Thuê xe Cát Bà"},
            {"pattern": r"\\btour\\b", "name": "Tour Cát Bà"},
            {"pattern": r"(ha noi|hai phong)", "name": "Di chuyển từ Hà Nội/Hải Phòng"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(hai san)", "name": "Hải sản Cát Bà"},
            {"pattern": r"(nha hang|quan an)", "name": "Nhà hàng Cát Bà"},
        ],
    },
    ...
    extra_travel_patterns=r"|tau|pha|ca treo|vinh|dao|beach|cruise"
)
...
def build_candidates():
    ...
    for kw_n, p in planner_data.items():
        ...
        # Ưu tiên lấy từ Google Planner theo request (Nhóm B ưu tiên Planner)
        score *= 100.0
