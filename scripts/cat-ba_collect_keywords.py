...
DESTINATION = DestinationConfig(
    ...
    entities=[
        "vịnh lan hạ", "lan hạ", "đảo khỉ", "bến bèo", "gia luận", 
        "hang quân y", "động trung trang", "pháo đài thần công", "cát cò", 
        "vườn quốc gia cát bà", "cáp treo cát bà", "bến gót", "phà gót", "cát hải"
    ],
    ...
    landmark_keywords=[
        "lan ha", "dao khi", "ben beo", "gia luan", "hang quan y", 
        "trung trang", "phao dai than cong", "cat co", "vuon quoc gia",
        "phà gót", "pha got", "cap treo"
    ],
    ...
    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            ...
            {"pattern": r"(vuon quoc gia|national park)", "name": "Vườn quốc gia Cát Bà"},
            {"pattern": r"(hang quan y)", "name": "Hang Quân Y"},
            {"pattern": r"(phao dai)", "name": "Pháo đài thần công"},
            {"pattern": r"(cat co)", "name": "Bãi tắm Cát Cò"},
        ],
        "Lưu trú": [
            {"pattern": r"(du thuyen|cruise)", "name": "Du thuyền Lan Hạ - Cát Bà"},
            {"pattern": r"(resort)", "name": "Resort Cát Bà"},
            {"pattern": r"(homestay)", "name": "Homestay Cát Bà"},
            {"pattern": r"(khach san|hotel)", "name": "Khách sạn Cát Bà"},
        ],
        "Di chuyển": [
            {"pattern": r"\\btour\\b", "name": "Tour Cát Bà"},
            {"pattern": r"(xe|limousine|bus)", "name": "Xe đi Cát Bà"},
            {"pattern": r"(pha got|ben got|tau|cao toc)", "name": "Tàu phà đi Cát Bà"},
            {"pattern": r"(cap treo)", "name": "Cáp treo Cát Bà"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(hai san|nha hang|quan an)", "name": "Hải sản & Ăn uống Cát Bà"},
        ],
    },
    ...
    extra_travel_patterns=r"|bien|bai bien|lan|thuy|dao|du thuyen|cruise",
)
