...
DESTINATION = DestinationConfig(
    ...
    entities=[
        "vinpearl", "hòn tre", "hon tre", "hòn tằm", "hon tam",
        "điệp sơn", "diep son", "tháp bà ponagar", "ponagar", "tháp bà", "thap ba",
        "hòn chồng", "hon chong", "chợ đầm", "cho dam",
        "viện hải dương học", "hai duong hoc", "bãi dài", "bai dai",
        "ninh vân bay", "ninh van", "dốc lết", "doc let", "hòn mun", "hon mun",
        "đảo khỉ", "dao khi", "suối khoáng nóng", "suoi khoang",
        "vịnh nha phu", "nha phu", "nhà thờ núi", "nha tho nui", "nhà thờ đá", "nha tho da", "vịnh ninh vân", "vinh ninh van", "đảo yến", "dao yen"
    ],

    districts=[
        "cam ranh", "ninh hòa", "vạn ninh", "diên khánh", "cam lâm", "lộc thọ", "phước hải"
    ],

    landmark_keywords=[
        "vinpearl", "hon tre", "hon tam", "diep son", "ponagar", "thap ba",
        "hon chong", "cho dam", "hai duong hoc", "bai dai", "ninh van", "doc let",
        "hon mun", "dao khi", "suoi khoang", "nha phu", "nha tho nui", "nha tho da", "dao yen"
    ],

    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(vinpearl)", "name": "Vinpearl Nha Trang"},
            {"pattern": r"(hon tre)", "name": "Hòn Tre"},
            {"pattern": r"(hon tam)", "name": "Hòn Tằm"},
            {"pattern": r"(diep son)", "name": "Đảo Điệp Sơn"},
            {"pattern": r"(ponagar|thap ba)", "name": "Tháp Bà Ponagar"},
            {"pattern": r"(hon chong)", "name": "Hòn Chồng"},
            {"pattern": r"(cho dam)", "name": "Chợ Đầm"},
            {"pattern": r"(hai duong hoc)", "name": "Viện Hải dương học"},
            {"pattern": r"(bai dai)", "name": "Bãi Dài"},
            {"pattern": r"(ninh van)", "name": "Vịnh Ninh Vân"},
            {"pattern": r"(doc let)", "name": "Dốc Lết"},
            {"pattern": r"(hon mun)", "name": "Hòn Mun"},
            {"pattern": r"(dao khi)", "name": "Đảo Khỉ"},
            {"pattern": r"(suoi khoang)", "name": "Suối khoáng nóng"},
            {"pattern": r"(nha phu)", "name": "Vịnh Nha Phu"},
            {"pattern": r"(nha tho nui|nha tho da)", "name": "Nhà thờ Đá"},
            {"pattern": r"(dao yen)", "name": "Đảo Yến"},
        ],
        "Lưu trú": [
            {"pattern": r"(resort|ninh van|hon tam|hon tre)", "name": "Resort Nha Trang"},
            {"pattern": r"(\b4 sao\b|4 sao)", "name": "Khách sạn 4 sao Nha Trang"},
            {"pattern": r"(\b5 sao\b|5 sao)", "name": "Khách sạn 5 sao Nha Trang"},
            {"pattern": r"(homestay)", "name": "Homestay Nha Trang"},
            {"pattern": r"(khach san|hotel|can ho|apartment|villa)", "name": "Khách sạn Nha Trang"},
        ],
        "Di chuyển": [
            {"pattern": r"(san bay|cam ranh|airport)", "name": "Sân bay Cam Ranh"},
            {"pattern": r"(ve may bay|may bay)", "name": "Vé máy bay đi Nha Trang"},
            {"pattern": r"(thue xe may|xe may)", "name": "Thuê xe máy Nha Trang"},
            {"pattern": r"(xe khach|limousine|giuong nam)", "name": "Xe khách đi Nha Trang"},
            {"pattern": r"(\btour\b|tour dao)", "name": "Tour Nha Trang"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(hai san|hải sản)", "name": "Hải sản Nha Trang"},
            {"pattern": r"(bun ca|bún cá)", "name": "Bún cá Nha Trang"},
            {"pattern": r"(nem nuong|nem nướng)", "name": "Nem nướng Nha Trang"},
            {"pattern": r"(bo ne|bò né)", "name": "Bò né Nha Trang"},
            {"pattern": r"(banh can|bánh căn)", "name": "Bánh căn Nha Trang"},
            {"pattern": r"(quan an|nha hang)", "name": "Quán ăn ngon Nha Trang"},
        ],
    },
    ...
    extra_travel_patterns="|bien|bãi biển|lan|diving|snorkeling|tour dao",
)
...
def is_invalid_keyword(keyword: str, kw_n: str) -> bool:
    """Loại bỏ từ khóa sai chính tả (telex lỗi) hoặc quá nhạy cảm/không phù hợp."""
    if re.search(r"(tinh yeu|tinh nhan|bieen|bieern|giá re|gia rẻ)", kw_n):
        return True
    
    # Loại bỏ "i resort nha trang giá vé" / "giá vé i resort nha trang"
    if re.search(r"(i resort.*gia ve|gia ve.*i resort)", kw_n):
        return True
        
    # Bổ sung lọc chính xác trên keyword gốc cho một số lỗi telex hoặc dính chữ
    kw_lower = keyword.lower()
    if re.search(r"(nhatrang|bieen|bieern|giá re\b|\bgia rẻ|vinpearls)", kw_lower):
        return True
    return False
