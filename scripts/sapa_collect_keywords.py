...
DESTINATION = DestinationConfig(
    ...
    entities=[
        "fansipan", "cát cát", "tả van", "tả phìn", "hàm rồng", "thác bạc", "thác tình yêu", "cầu kính", "rồng mây", "đèo ô quy hồ", "ô quy hồ", "mường hoa", "y tí", "y tý"
    ],
    ...
    landmark_keywords=[
        "fansipan", "fanxipan", "cat cat", "ta van", "ta phin", "ham rong", "thac bac", "thac tinh yeu", "cau kinh", "rong may", "o quy ho", "muong hoa", "y ti", "y ty"
    ],

    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(fansipan|fanxipan|phan xi pang)", "name": "Đỉnh Fansipan"},
            {"pattern": r"(cat cat)", "name": "Bản Cát Cát"},
            {"pattern": r"(ta van)", "name": "Bản Tả Van"},
            {"pattern": r"(ta phin)", "name": "Bản Tả Phìn"},
            {"pattern": r"(ham rong)", "name": "Núi Hàm Rồng"},
            {"pattern": r"(thac bac|thac tinh yeu)", "name": "Thác Bạc & Thác Tình Yêu"},
            {"pattern": r"(cau kinh|rong may)", "name": "Cầu kính Rồng Mây"},
            {"pattern": r"(o quy ho)", "name": "Đèo Ô Quy Hồ"},
            {"pattern": r"(muong hoa)", "name": "Thung lũng Mường Hoa"},
        ],
        "Lưu trú": [
            {"pattern": r"(homestay)", "name": "Homestay Sapa"},
            {"pattern": r"(\\b5 sao\\b)", "name": "Khách sạn 5 sao Sapa"},
            {"pattern": r"(\\b4 sao\\b)", "name": "Khách sạn 4 sao Sapa"},
            {"pattern": r"(resort)", "name": "Resort Sapa"},
        ],
        "Di chuyển": [
            {"pattern": r"(xe giuong n|xe cabin)", "name": "Xe giường nằm/cabin đi Sapa"},
            {"pattern": r"(limousine)", "name": "Xe limousine đi Sapa"},
            {"pattern": r"(tau hoa|tau) (sapa|lao cai)", "name": "Tàu hỏa đi Sapa/Lào Cai"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(ca hoi|cá hồi)", "name": "Cá hồi Sapa"},
            {"pattern": r"(thang co|thắng cố)", "name": "Thắng cố Sapa"},
            {"pattern": r"(lon ban|lợn|nha hang|quan an)", "name": "Nhà hàng & Quán ăn Sapa"},
        ],
    },
    ...
    extra_travel_patterns=r"|trekking|san may|săn mây",
)
