...
DESTINATION = DestinationConfig(
    ...
    entities=[
        "fansipan", "cát cát", "thác bạc", "đèo ô quy hồ", "hàm rồng", "tả van", "tả phìn", "mường hoa", "y tí", "y tý"
    ],
    districts=[
        "sa pa", "sapa"
    ],
    landmark_keywords=[
        "fansipan", "cat cat", "thac bac", "o quy ho", "ham rong", "ta van", "ta phin", "muong hoa", "y ti", "y ty"
    ],
    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(fansipan|fanxipan|phan xi pang)", "name": "Fansipan"},
            {"pattern": r"(cat cat|bản cát cát)", "name": "Bản Cát Cát"},
            {"pattern": r"(thac bac)", "name": "Thác Bạc"},
            {"pattern": r"(o quy ho|ô quy hồ)", "name": "Đèo Ô Quy Hồ"},
        ...
        "Lưu trú": [
            {"pattern": r"(\\b5 sao\\b|5 sao)", "name": "Khách sạn 5 sao Sa Pa"},
            {"pattern": r"(\\b4 sao\\b|4 sao)", "name": "Khách sạn 4 sao Sa Pa"},
            {"pattern": r"(resort)", "name": "Resort Sa Pa"},
            {"pattern": r"(homestay)", "name": "Homestay Sa Pa"},
        ],
        "Di chuyển": [
            {"pattern": r"(limousine|xe giuong nam|xe khach)", "name": "Xe đi Sa Pa"},
            {"pattern": r"(\\btour\\b)", "name": "Tour Sa Pa"},
            {"pattern": r"(tau hoa|ve tau)", "name": "Tàu đi Sa Pa"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(nha hang)", "name": "Nhà hàng Sa Pa"},
            {"pattern": r"(ca hoi|cá hồi)", "name": "Cá hồi Sa Pa"},
            {"pattern": r"(lon ban|lợn bản|thit \w+)", "name": "Đặc sản Sa Pa"},
            {"pattern": r"(thang co|thắng cố)", "name": "Thắng cố Sa Pa"},
        ],
    },
    province_display_overrides={
        "sa pa": "Sa Pa",
    },
    extra_travel_patterns="|trekking|leo nui|canh dong lua|ruong bac thang|tam la dao"
)
