...
DESTINATION = DestinationConfig(
    ...
    entities=[
        "ghềnh đá đĩa", "gành đá đĩa", "mũi điện", "bãi xép", "nhà thờ mằng lăng", 
        "mằng lăng", "đảo điệp sơn", "điệp sơn", "hòn yến", "vũng rô", 
        "đầm ô loan", "ô loan", "tháp nhạn", "tháp đôi", "cao nguyên vân hoà",
        "hải đăng đại lãnh", "biển bãi môn", "bãi môn", "vịnh xuân đài", "xuân đài",
        "hòn nưa", "hòn chùa", "cù lao mái nhà", "mái nhà", "đèo cả"
    ],
    districts=[
        "tuy hoà", "tuy hoa", "sông cầu", "song cau", "đông hoà", "dong hoa", 
        "đồng xuân", "dong xuan", "sông hinh", "song hinh", "sơn hoà", "son hoa", 
        "phú hoà", "phu hoa", "tuy an", "tây hoà", "tay hoa"
    ],
    landmark_keywords=[
        "ghenh da dia", "ganh da dia", "mui dien", "bai xep", "mang lang", 
        "diep son", "hon yen", "vung ro", "o loan", "thap nhan", "van hoa",
        "dai lanh", "bai mon", "xuan dai", "hon nua", "hon chua", "mai nha", "deo ca"
    ],
    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(ghenh da dia|ganh da dia)", "name": "Ghềnh Đá Đĩa"},
            {"pattern": r"(mui dien|dai lanh)", "name": "Mũi Điện / Đại Lãnh"},
            {"pattern": r"(bai xep)", "name": "Bãi Xép"},
            {"pattern": r"(mang lang)", "name": "Nhà thờ Mằng Lăng"},
            {"pattern": r"(diep son)", "name": "Đảo Điệp Sơn"},
            {"pattern": r"(hon yen)", "name": "Hòn Yến"},
            {"pattern": r"(vung ro)", "name": "Vịnh Vũng Rô"},
            {"pattern": r"(o loan)", "name": "Đầm Ô Loan"},
            {"pattern": r"(thap nhan)", "name": "Tháp Nhạn"},
            {"pattern": r"(xuan dai)", "name": "Vịnh Xuân Đài"},
            {"pattern": r"(van hoa)", "name": "Cao nguyên Vân Hòa"},
        ],
        "Lưu trú": [
            {"pattern": r"(homestay)", "name": "Homestay Phú Yên"},
            {"pattern": r"(resort)", "name": "Resort Phú Yên"},
            {"pattern": r"(khach san|hotel)", "name": "Khách sạn Phú Yên"},
        ],
        "Di chuyển": [
            {"pattern": r"(san bay|airport|tuy hoa)", "name": "Sân bay Tuy Hoà & di chuyển"},
            {"pattern": r"(thue xe may|xe may)", "name": "Thuê xe máy Phú Yên"},
            {"pattern": r"\btour\b", "name": "Tour Phú Yên"},
            {"pattern": r"(xe|taxi|thue xe)", "name": "Thuê xe Phú Yên"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(mat ca ngu|ca ngu)", "name": "Mắt cá ngừ đại dương Phú Yên"},
            {"pattern": r"(bo mot nang)", "name": "Bò một nắng Phú Yên"},
            {"pattern": r"(hai san)", "name": "Hải sản Phú Yên"},
            {"pattern": r"(banh canh|he)", "name": "Bánh canh hẹ Phú Yên"},
        ],
    },
    ...
    extra_travel_patterns=r"|bien|bai bien|lan|camping|check in|phuot",
)
...
def build_candidates():
    ...
    for kw_n, p in planner_data.items():
        ...
        score = base_score * comp_factor * bonus_multiplier * 50.0  # Tăng trọng số cho dữ liệu Google Planner
