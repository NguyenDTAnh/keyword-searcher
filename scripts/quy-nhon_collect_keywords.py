...
DESTINATION = DestinationConfig(
    ...
    entities=[
        # Địa danh nổi tiếng chỉ thuộc Quy Nhơn / Bình Định
        "eo gió", "eo gio", "ghềnh ráng", "ghenh rang",
        "kỳ co", "ky co", "hòn khô", "hon kho",
        "bãi xép", "bai xep", "tháp đôi", "thap doi",
        "bãi trứng", "bai trung", "cù lao xanh", "cu lao xanh",
        "hầm hô", "ham ho",
        "flc quy nhon", "anantara", "avani",
        "mũi vi rồng", "mui vi rong",
        "trung lương", "trung luong",
        "nhơn lý", "nhon ly", "nhơn hải", "nhon hai",
    ],

    districts=[
        "tuy phước", "tuy phuoc", "phù cát", "phu cat",
        "an nhơn", "an nhon", "phù mỹ", "phu my",
        "hoài nhơn", "hoai nhon", "tây sơn", "tay son",
    ],

    landmark_keywords=[
        # Dạng KHÔNG DẤU để match
        "eo gio", "ghenh rang", "ky co", "hon kho",
        "bai xep", "thap doi", "bai trung", "cu lao xanh",
        "ham ho", "mui vi rong", "trung luong",
        "nhon ly", "nhon hai",
    ],

    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(eo gio)", "name": "Eo Gió"},
            {"pattern": r"(ghenh rang)", "name": "Ghềnh Ráng Tiên Sa"},
            {"pattern": r"(ky co)", "name": "Kỳ Co"},
            {"pattern": r"(hon kho)", "name": "Hòn Khô"},
            {"pattern": r"(bai xep)", "name": "Bãi Xép"},
            {"pattern": r"(thap doi)", "name": "Tháp Đôi"},
            {"pattern": r"(cu lao xanh)", "name": "Cù Lao Xanh"},
            {"pattern": r"(ham ho)", "name": "Hầm Hô"},
            {"pattern": r"(mui vi rong)", "name": "Mũi Vi Rồng"},
            {"pattern": r"(trung luong)", "name": "Trung Lương"},
            {"pattern": r"(nhon ly)", "name": "Làng chài Nhơn Lý"},
            {"pattern": r"(nhon hai)", "name": "Nhơn Hải"},
        ],
        "Lưu trú": [
            {"pattern": r"(flc)", "name": "FLC Quy Nhơn"},
            {"pattern": r"(anantara)", "name": "Anantara Quy Nhơn"},
            {"pattern": r"(avani)", "name": "Avani Quy Nhơn"},
            {"pattern": r"(anya)", "name": "Anya Hotel Quy Nhơn"},
            {"pattern": r"(maia)", "name": "Maia Resort Quy Nhơn"},
            {"pattern": r"(crown retreat)", "name": "Crown Retreat Quy Nhơn"},
            {"pattern": r"(seaside boutique)", "name": "Seaside Boutique Resort Quy Nhơn"},
            {"pattern": r"(le mint)", "name": "Le Mint Hotel Quy Nhơn"},
            {"pattern": r"(muong thanh)", "name": "Mường Thanh Quy Nhơn"},
            {"pattern": r"(hoang yen)", "name": "Khách sạn Hoàng Yến Quy Nhơn"},
            {"pattern": r"(sai gon|saigon)", "name": "Khách sạn Sài Gòn Quy Nhơn"},
            {"pattern": r"(fleur de lys)", "name": "Fleur de Lys Quy Nhơn"},
            {"pattern": r"(hai au)", "name": "Khách sạn Hải Âu Quy Nhơn"},
            {"pattern": r"(resort)", "name": "Resort Quy Nhơn"},
            {"pattern": r"(\b4 sao\b|4 sao)", "name": "Khách sạn 4 sao Quy Nhơn"},
            {"pattern": r"(\b5 sao\b|5 sao)", "name": "Khách sạn 5 sao Quy Nhơn"},
            {"pattern": r"(homestay)", "name": "Homestay Quy Nhơn"},
            {"pattern": r"(khach san|hotel|can ho|apartment|villa)", "name": "Khách sạn Quy Nhơn"},
        ],
        "Di chuyển": [
            {"pattern": r"(san bay|airport|phu cat)", "name": "Sân bay Phù Cát & di chuyển"},
            {"pattern": r"(ve may bay|may bay)", "name": "Vé máy bay đi Quy Nhơn"},
            {"pattern": r"(thue xe may|xe may)", "name": "Thuê xe máy Quy Nhơn"},
            {"pattern": r"(xe khach|limousine|giuong nam)", "name": "Xe khách đi Quy Nhơn"},
            {"pattern": r"(\btour\b|tour dao)", "name": "Tour Quy Nhơn"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(hai san|hải sản)", "name": "Hải sản Quy Nhơn"},
            {"pattern": r"(banh it|bánh ít)", "name": "Bánh ít lá gai Bình Định"},
            {"pattern": r"(bun cha ca|bún chả cá)", "name": "Bún chả cá Quy Nhơn"},
            {"pattern": r"(nem|chả)\s*(ram|cuon|nuong)", "name": "Nem & chả Quy Nhơn"},
            {"pattern": r"(quan an|nha hang)", "name": "Quán ăn ngon Quy Nhơn"},
        ],
    },
    ...
    extra_travel_patterns="|bien|bai bien|lan|diving|snorkeling|tour dao",
)
