...
DESTINATION = DestinationConfig(
    ...
    entities=[
        "tràng an", "bái đính", "tam cốc", "bích động", "hoa lư", "cúc phương",
        "vân long", "thung nham", "đan viện châu sơn", "hang múa",
        "thung nắng", "tuyệt tình cốc", "cố đô", "chùa bái đính",
        "khu du lịch sinh thái", "kdl sinh thái"
    ],

    districts=[
        "gia viễn", "hoa lư", "kim sơn", "nho quan", "yên khánh", "yên mô",
        "tam điệp", "thành phố ninh bình"
    ],

    landmark_keywords=[
        "trang an", "bai dinh", "tam coc", "bich dong", "hoa lu", "cuc phuong",
        "van long", "thung nham", "chau son", "hang mua", "thung nang",
        "tuyet tinh coc", "co do"
    ],

    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(trang an|tràng an)", "name": "Tràng An"},
            {"pattern": r"(bai dinh|bái đính)", "name": "Chùa Bái Đính"},
            {"pattern": r"(tam coc|tam cốc|bich dong|bích động)", "name": "Tam Cốc - Bích Động"},
            {"pattern": r"(hang mua|hang múa)", "name": "Hang Múa"},
            {"pattern": r"(hoa lu|hoa lư)", "name": "Cố đô Hoa Lư"},
            {"pattern": r"(cuc phuong|cúc phương)", "name": "Rừng Cúc Phương"},
            {"pattern": r"(tuyet tinh coc|tuyệt tình cốc)", "name": "Tuyệt Tình Cốc"},
            {"pattern": r"(van long|thung nham)", "name": "Đầm Vân Long / Thung Nham"},
        ],
        "Lưu trú": [
            {"pattern": r"(resort|eco lodge)", "name": "Resort Ninh Bình"},
            {"pattern": r"(homestay)", "name": "Homestay Ninh Bình"},
            {"pattern": r"(khach san|hotel)", "name": "Khách sạn Ninh Bình"},
        ],
        "Di chuyển": [
            {"pattern": r"(limousine)", "name": "Limousine đi Ninh Bình"},
            {"pattern": r"(tour)", "name": "Tour Ninh Bình"},
            {"pattern": r"(xe|tau|ghe|do)", "name": "Di chuyển Ninh Bình"},
        ],
        "Ẩm thực (F&B)": [
