...
DESTINATION = DestinationConfig(
    ...
    entities=[
        "tràng an", "trang an", "tam cốc", "tam coc", "bái đính", "bai dinh", 
        "cúc phương", "cuc phuong", "hoa lư", "hoa lu", "thung nham", "hang múa", 
        "hang mua", "vân long", "van long", "bích động", "bich dong", "địch lộng", 
        "dich long", "đan viện châu sơn", "chau son", "tuyệt tình cốc", "am tiên"
    ],

    districts=[
        "gia viễn", "gia vien", "hoa lư", "hoa lu", "kim sơn", "kim son", 
        "nho quan", "nhoquan", "yên khánh", "yen khanh", "yên mô", "yen mo", 
        "tam điệp", "tam diep"
    ],

    landmark_keywords=[
        "trang an", "tam coc", "bai dinh", "cuc phuong", "hoa lu", "thung nham", 
        "hang mua", "van long", "bich dong", "dich long", "chau son", "am tien", 
        "tuyet tinh coc"
    ],

    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(trang an)", "name": "Tràng An"},
            {"pattern": r"(tam coc|bich dong)", "name": "Tam Cốc - Bích Động"},
            {"pattern": r"(bai dinh)", "name": "Chùa Bái Đính"},
            {"pattern": r"(cuc phuong)", "name": "Rừng Cúc Phương"},
            {"pattern": r"(hang mua)", "name": "Hang Múa"},
            {"pattern": r"(hoa lu)", "name": "Cố đô Hoa Lư"},
            {"pattern": r"(thung nham)", "name": "Thung Nham"},
            {"pattern": r"(van long)", "name": "Đầm Vân Long"},
            {"pattern": r"(tuyet tinh coc|am tien)", "name": "Tuyệt Tình Cốc (Động Am Tiên)"},
        ],
        "Lưu trú": [
            {"pattern": r"(\b5 sao\b)", "name": "Khách sạn 5 sao Ninh Bình"},
            {"pattern": r"(\b4 sao\b)", "name": "Khách sạn 4 sao Ninh Bình"},
            {"pattern": r"(resort|homestay)", "name": "Resort / Homestay Ninh Bình"},
        ],
        "Di chuyển": [
            {"pattern": r"(limousine|xe khach|thue xe)", "name": "Phượng tiện đi Ninh Bình"},
            {"pattern": r"\btour\b", "name": "Tour Ninh Bình"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(de|dê)", "name": "Thịt dê Ninh Bình"},
            {"pattern": r"(com chay|cơm cháy)", "name": "Cơm cháy Ninh Bình"},
        ],
    },
