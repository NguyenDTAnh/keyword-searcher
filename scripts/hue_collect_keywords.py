...
DESTINATION = DestinationConfig(
    ...
    name_variants=[
        "huế", "hue", "thừa thiên huế", "thua thien hue", "cố đô huế", "co do hue",
    ],

    entities=[
        # Kinh thành & di tích UNESCO
        "đại nội", "dai noi", "kinh thành huế", "kinh thanh hue",
        "thành nội", "thanh noi",
        "tử cấm thành", "tu cam thanh",
        # Lăng tẩm
        "lăng tự đức", "lang tu duc", "lăng minh mạng", "lang minh mang",
        "lăng khải định", "lang khai dinh", "lăng gia long", "lang gia long",
        "lăng tẩm", "lang tam",
        # Chùa & tôn giáo
        "chùa thiên mụ", "chua thien mu", "thiên mụ", "thien mu",
        "thánh địa la vang", "thanh dia la vang", "la vang",
        # Sông & cầu
        "sông hương", "song huong", "cầu trường tiền", "cau truong tien",
        "phá tam giang", "pha tam giang", "tam giang",
        # Vườn quốc gia & biển
        "bạch mã", "bach ma", "vườn quốc gia bạch mã",
        "lăng cô", "lang co",
        "thuận an", "thuan an",
        # Trường Quốc Học & phố cổ
        "trường quốc học", "truong quoc hoc", "quốc học", "quoc hoc",
        "phố cổ huế", "pho co hue",
        # Chợ & đặc sản
        "chợ đông ba", "cho dong ba",
        # Địa danh nổi tiếng khác
        "suối nước nóng thanh tân", "thanh tan",
        "đồi vọng cảnh", "doi vong canh", "vọng cảnh", "vong canh",
        "đảo ngọc", "dao ngoc",
        "núi ngự bình", "nui ngu binh", "ngự bình", "ngu binh",
    ],

    districts=[
        "phú vang", "hương thủy", "hương trà", "phú lộc", "phong điền",
        "quảng điền", "a lưới", "nam đông", "phú hội",
    ],

    landmark_keywords=[
        "dai noi", "kinh thanh", "thanh noi", "tu cam thanh",
        "lang tu duc", "lang minh mang", "lang khai dinh", "lang gia long", "lang tam",
        "chua thien mu", "thien mu", "la vang",
        "song huong", "cau truong tien", "pha tam giang", "tam giang",
        "bach ma", "lang co", "thuan an",
        "truong quoc hoc", "quoc hoc", "pho co",
        "cho dong ba",
        "thanh tan", "vong canh", "dao ngoc", "ngu binh",
    ],

    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(dai noi|kinh thanh|thanh noi|tu cam thanh)", "name": "Đại Nội – Kinh thành Huế"},
            {"pattern": r"(lang tu duc)", "name": "Lăng Tự Đức"},
            {"pattern": r"(lang minh mang)", "name": "Lăng Minh Mạng"},
            {"pattern": r"(lang khai dinh)", "name": "Lăng Khải Định"},
            {"pattern": r"(lang gia long)", "name": "Lăng Gia Long"},
            {"pattern": r"(lang tam)", "name": "Lăng tẩm Huế"},
            {"pattern": r"(chua thien mu|thien mu)", "name": "Chùa Thiên Mụ"},
            {"pattern": r"(la vang)", "name": "Thánh địa La Vang"},
            {"pattern": r"(song huong)", "name": "Sông Hương"},
            {"pattern": r"(cau truong tien)", "name": "Cầu Trường Tiền"},
            {"pattern": r"(bach ma)", "name": "Vườn Quốc gia Bạch Mã"},
            {"pattern": r"(lang co)", "name": "Biển Lăng Cô"},
            {"pattern": r"(thuan an)", "name": "Biển Thuận An"},
            {"pattern": r"(pha tam giang|tam giang)", "name": "Phá Tam Giang"},
            {"pattern": r"(truong quoc hoc|quoc hoc)", "name": "Trường Quốc Học"},
            {"pattern": r"(cho dong ba)", "name": "Chợ Đông Ba"},
            {"pattern": r"(thanh tan)", "name": "Suối nước nóng Thanh Tân"},
            {"pattern": r"(vong canh)", "name": "Đồi Vọng Cảnh"},
            {"pattern": r"(dao ngoc)", "name": "Đảo Ngọc Huế"},
            {"pattern": r"(pho co)", "name": "Phố cổ Huế"},
        ],
        "Lưu trú": [
            {"pattern": r"(vinpearl|melia)", "name": "Vinpearl / Melia Huế"},
            {"pattern": r"(muong thanh)", "name": "Mường Thanh Huế"},
            {"pattern": r"(huong giang)", "name": "Khách sạn Hương Giang"},
            {"pattern": r"(saigon morin|morin)", "name": "Saigon Morin Huế"},
            {"pattern": r"(alba)", "name": "Khách sạn Alba Huế"},
            {"pattern": r"(silk path)", "name": "Silk Path Huế"},
            {"pattern": r"(imperial)", "name": "Khách sạn Imperial Huế"},
            {"pattern": r"(pilgrimage village|pilgrimage)", "name": "Pilgrimage Village Huế"},
            {"pattern": r"(laguna)", "name": "Laguna Huế"},
            {"pattern": r"(angsana)", "name": "Angsana Lăng Cô"},
            {"pattern": r"(banyan tree)", "name": "Banyan Tree Lăng Cô"},
            {"pattern": r"(resort)", "name": "Resort Huế"},
            {"pattern": r"(villa)", "name": "Villa Huế"},
            {"pattern": r"(\b3 sao\b|3 sao)", "name": "Khách sạn 3 sao Huế"},
            {"pattern": r"(\b4 sao\b|4 sao)", "name": "Khách sạn 4 sao Huế"},
            {"pattern": r"(\b5 sao\b|5 sao)", "name": "Khách sạn 5 sao Huế"},
            {"pattern": r"(homestay)", "name": "Homestay Huế"},
            {"pattern": r"(khach san|hotel|ks )", "name": "Khách sạn Huế"},
        ],
        "Di chuyển": [
            {"pattern": r"(san bay|airport|phu bai)", "name": "Sân bay Phú Bài – Huế"},
            {"pattern": r"(ve may bay|may bay)", "name": "Vé máy bay đi Huế"},
            {"pattern": r"(thue xe|xe may)", "name": "Thuê xe máy Huế"},
            {"pattern": r"(xe khach|limousine|giuong nam)", "name": "Xe khách đi Huế"},
            {"pattern": r"(xe dien)", "name": "Xe điện tham quan Huế"},
            {"pattern": r"(ve tham quan)", "name": "Vé tham quan Huế"},
            {"pattern": r"\btour\b", "name": "Tour Huế"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(bun bo)", "name": "Bún bò Huế"},
            {"pattern": r"(banh beo|banh loc|banh nam|banh khoai)", "name": "Bánh Huế (bèo/lọc/nậm/khoai)"},
            {"pattern": r"(com hen)", "name": "Cơm hến Huế"},
            {"pattern": r"(che hue|chè huế)", "name": "Chè Huế"},
            {"pattern": r"(dac san|đặc sản)", "name": "Đặc sản Huế"},
            {"pattern": r"(am thuc|an uong|thuc an|do an)", "name": "Ẩm thực Huế"},
            {"pattern": r"(quan an|nha hang)", "name": "Quán ăn ngon Huế"},
        ],
    },
    ...
    extra_travel_patterns="|bien|bãi biển|lang co|bach ma|tam giang|co do|kinh thanh",
)
...
def build_candidates():
    ...
    for r in gsc_rows:
        ...
        if re.search(r"(tinh yeu|tinh nhan|nha nghi|nhà nghỉ)", kw_n):
            continue
