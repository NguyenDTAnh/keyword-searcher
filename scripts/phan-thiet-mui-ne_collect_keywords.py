...
DESTINATION = DestinationConfig(
    ...
    name_variants=[
        "phan thiết", "phan thiet", "phanthiet",
        "mũi né", "mui ne", "muine",
        "phan thiết mũi né", "phan thiet mui ne",
    ],

    entities=[
        # Địa danh nổi tiếng chỉ thuộc Phan Thiết / Mũi Né / Bình Thuận
        "bàu trắng", "bau trang", "bàu sen", "bau sen",
        "đồi cát bay", "doi cat bay", "đồi cát đỏ", "doi cat do",
        "đồi cát vàng", "doi cat vang",
        "suối tiên", "suoi tien",
        "hòn rơm", "hon rom",
        "lầu ông hoàng", "lau ong hoang",
        "tháp poshanư", "thap poshanu", "tháp chàm", "thap cham",
        "chùa núi tà cú", "chua nui ta cu", "núi tà cú", "nui ta cu",
        "kê gà", "ke ga", "hải đăng kê gà", "hai dang ke ga",
        "hàm tiến", "ham tien",
        "terracotta", "movenpick", "mövenpick",
        "anantara mui ne", "novotel mui ne",
        "pandanus", "sea links", "sealinks",
        "the cliff", "mia resort",
        "coco beach", "amaryllis",
        "làng chài mũi né", "lang chai mui ne",
        "bãi rạng", "bai rang",
        "hòn bà", "hon ba",
        "trung tâm thể thao biển", "water sport",
    ],

    districts=[
        "hàm tiến", "ham tien", "hàm thuận nam", "ham thuan nam",
        "hàm thuận bắc", "ham thuan bac",
        "phú hài", "phu hai", "phú thủy", "phu thuy",
        "thanh hải", "thanh hai", "bình hưng", "binh hung",
        "lạc đạo", "lac dao", "đức long", "duc long",
        "tuy phong", "la gi", "la gì",
    ],

    landmark_keywords=[
        # Dạng KHÔNG DẤU để match
        "bau trang", "bau sen", "doi cat bay", "doi cat do", "doi cat vang",
        "suoi tien", "hon rom", "lau ong hoang",
        "thap poshanu", "thap cham",
        "nui ta cu", "ke ga", "hai dang ke ga",
        "bai rang", "lang chai mui ne", "hon ba",
    ],

    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(bau trang|bau sen)", "name": "Bàu Trắng"},
            {"pattern": r"(doi cat bay)", "name": "Đồi cát bay Mũi Né"},
            {"pattern": r"(doi cat do)", "name": "Đồi cát đỏ Mũi Né"},
            {"pattern": r"(doi cat vang)", "name": "Đồi cát vàng Mũi Né"},
            {"pattern": r"(suoi tien)", "name": "Suối Tiên Mũi Né"},
            {"pattern": r"(hon rom)", "name": "Hòn Rơm"},
            {"pattern": r"(lau ong hoang)", "name": "Lầu Ông Hoàng"},
            {"pattern": r"(thap poshanu|thap cham|po sha)", "name": "Tháp Poshanư"},
            {"pattern": r"(nui ta cu|ta cu)", "name": "Núi Tà Cú"},
            {"pattern": r"(ke ga|hai dang)", "name": "Hải đăng Kê Gà"},
            {"pattern": r"(lang chai)", "name": "Làng chài Mũi Né"},
            {"pattern": r"(bai rang)", "name": "Bãi Rạng"},
            {"pattern": r"(hon ba)", "name": "Hòn Bà"},
        ],
        "Lưu trú": [
            {"pattern": r"(terracotta)", "name": "Terracotta Resort Mũi Né"},
            {"pattern": r"(movenpick|mövenpick)", "name": "Mövenpick Resort Mũi Né"},
            {"pattern": r"(anantara)", "name": "Anantara Mũi Né"},
            {"pattern": r"(novotel)", "name": "Novotel Phan Thiết"},
            {"pattern": r"(pandanus)", "name": "Pandanus Resort Mũi Né"},
            {"pattern": r"(sea ?links|sealinks)", "name": "Sea Links Mũi Né"},
            {"pattern": r"(the cliff)", "name": "The Cliff Resort Mũi Né"},
            {"pattern": r"(mia resort)", "name": "Mia Resort Mũi Né"},
            {"pattern": r"(coco beach)", "name": "Coco Beach Resort"},
            {"pattern": r"(amaryllis)", "name": "Amaryllis Resort Mũi Né"},
            {"pattern": r"(muong thanh)", "name": "Mường Thanh Mũi Né"},
            {"pattern": r"(centara)", "name": "Centara Mũi Né"},
            {"pattern": r"(resort.*gan bien|gan bien.*resort)", "name": "Resort gần biển Mũi Né"},
            {"pattern": r"(\b4 sao\b|4 sao)", "name": "Resort 4 sao Mũi Né"},
            {"pattern": r"(\b5 sao\b|5 sao)", "name": "Resort 5 sao Mũi Né"},
            {"pattern": r"(\b3 sao\b|3 sao)", "name": "Khách sạn 3 sao Phan Thiết"},
            {"pattern": r"(resort)", "name": "Resort Mũi Né"},
            {"pattern": r"(homestay)", "name": "Homestay Mũi Né"},
            {"pattern": r"(villa)", "name": "Villa Mũi Né"},
            {"pattern": r"(khach san|hotel|can ho|apartment)", "name": "Khách sạn Phan Thiết"},
        ],
        "Di chuyển": [
            {"pattern": r"(san bay|airport)", "name": "Sân bay & di chuyển Phan Thiết"},
            {"pattern": r"(ve may bay|may bay)", "name": "Vé máy bay đi Phan Thiết"},
            {"pattern": r"(thue xe may|xe may)", "name": "Thuê xe máy Mũi Né"},
            {"pattern": r"(xe khach|limousine|giuong nam)", "name": "Xe khách đi Phan Thiết"},
            {"pattern": r"(tau hoa|tau lua|ga phan thiet)", "name": "Tàu hỏa đi Phan Thiết"},
            {"pattern": r"(\btour\b)", "name": "Tour Phan Thiết - Mũi Né"},
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(hai san|hải sản)", "name": "Hải sản Phan Thiết"},
            {"pattern": r"(banh canh|bánh canh)", "name": "Bánh canh chả cá Phan Thiết"},
            {"pattern": r"(nuoc mam|nước mắm)", "name": "Nước mắm Phan Thiết"},
            {"pattern": r"(banh xeo|bánh xèo|banh can|bánh căn)", "name": "Bánh xèo & bánh căn Phan Thiết"},
            {"pattern": r"(quan an|nha hang)", "name": "Quán ăn ngon Phan Thiết"},
            {"pattern": r"(cafe|ca phe|coffee)", "name": "Cafe Mũi Né"},
        ],
    },
    ...
    extra_travel_patterns="|bien|bai bien|luot van|luot song|kitesurfing|kite|windsurf|cat|doi cat|water sport",
)

# Danh sách từ khóa cần loại bỏ theo yêu cầu (Agoda, Viettravel, Nhà nghỉ)
EXCLUDED_TERMS = ["agoda", "viettravel", "nha nghi"]
...
def is_invalid_keyword(keyword: str, kw_n: str) -> bool:
    """Loại bỏ từ khóa sai chính tả, nhạy cảm, hoặc nằm trong danh sách excluded."""
    if re.search(r"(tinh yeu|tinh nhan|bieen|bieern)", kw_n):
        return True
    
    # Loại bỏ các từ khóa trong danh sách EXCLUDED_TERMS (agoda, viettravel, nhà nghỉ)
...
def build_candidates():
    ...
    for r in gsc_rows:
        ...
        # Lọc bỏ từ khoá nhạy cảm/không phù hợp/lỗi gõ telex
        if is_invalid_keyword(kw, kw_n):
            continue
    ...
    for kw_n, p in planner_data.items():
        ...
        # Nhóm B ưu tiên keyword từ Google Planner
        score *= 100.0 # Boost mạnh
