...
DESTINATION = DestinationConfig(
    ...
    name_variants=[
        "phú quốc", "phu quoc", "phuquoc", "đảo ngọc"
    ],

    entities=[
        "vinpearl", "grand world", "safari", "hòn thơm", "bãi sao", "bãi dài", 
        "bãi trường", "chợ đêm phú quốc", "cáp treo hòn thơm", "hòn móng tay", 
        "hòn gầm ghì", "hòn mây rút", "dinh cậu", "nhà tù phú quốc", "chùa hộ quốc", 
        "làng chài hàm ninh", "suối tranh", "suối đá bàn"
    ],

    districts=[
        "dương đông", "an thới", "cửa cạn", "gành dầu", "hàm ninh", "bãi thơm", 
        "thổ châu", "dương tơ", "cửa dương"
    ],

    landmark_keywords=[
        "vinpearl", "grand world", "safari", "hon thom", "bai sao", "bai dai", 
        "bai truong", "cho dem", "cap treo", "hon mong tay", "hon gam ghi", 
        "hon may rut", "dinh cau", "nha tu phu quoc", "chua ho quoc", 
        "lang chai ham ninh", "suoi tranh", "suoi da ban"
    ],

    cluster_rules={
        "Địa danh tham quan / Văn hóa - Lịch sử": [
            {"pattern": r"(vinwonders|vinpearl|safari)", "name": "VinWonders & Safari Phú Quốc"},
            {"pattern": r"(grand world)", "name": "Grand World Phú Quốc"},
            {"pattern": r"(hon thom|cap treo)", "name": "Hòn Thơm & Cáp treo"},
            {"pattern": r"(hon mong tay|hon gam ghi|hon may rut)", "name": "Các hòn đảo đẹp"},
            {"pattern": r"(bai sao|bai dai|bai kem|bai truong)", "name": "Các bãi biển nổi tiếng"},
            {"pattern": r"(cho dem|dinh cau|nha tu|suoi|chua ho quoc|lang chai)", "name": "Tham quan văn hóa Phú Quốc"}
        ],
        "Lưu trú": [
            {"pattern": r"(\\b5 sao\\b|nam sao)", "name": "Resort 5 sao Phú Quốc"},
            {"pattern": r"(resort|villa|khu nghi duong)", "name": "Resort & Villa Phú Quốc"},
            {"pattern": r"(khach san|hotel)", "name": "Khách sạn Phú Quốc"},
            {"pattern": r"(homestay)", "name": "Homestay Phú Quốc"}
        ],
        "Di chuyển": [
            {"pattern": r"(ve may bay|vé máy bay)", "name": "Vé máy bay đi Phú Quốc"},
            {"pattern": r"(tau|phà|superdong)", "name": "Tàu/Phà đi Phú Quốc"},
            {"pattern": r"(thue xe|cho thue xe)", "name": "Thuê xe Phú Quốc"},
            {"pattern": r"(tour|combo)", "name": "Tour & Combo Phú Quốc"}
        ],
        "Ẩm thực (F&B)": [
            {"pattern": r"(bun quay)", "name": "Bún quậy Phú Quốc"},
            {"pattern": r"(goi ca trich)", "name": "Gỏi cá trích Phú Quốc"},
            {"pattern": r"(nha hang|quan an|hai san|dac san)", "name": "Nhà hàng & Hải sản Phú Quốc"}
        ]
    },
    ...
    extra_travel_patterns=r"|bien|bai bien|dao|hon|lan|diving|snorkeling|cau muc|cau ca|cano"
)
...
def build_candidates():
    ...
    for r in gsc_rows:
        ...
        # Lọc bỏ từ khoá OTA/competitor và nhạy cảm
        if re.search(r"(tinh yeu|tinh nhan|nha nghi|phong tro|6 sao|7 sao|viettravel|vietravel|agoda|tripadvisor|traveloka|vivu|vntrip|airbnb)", kw_n):
            continue
    ...
    for kw_n, p in planner_data.items():
        ...
        score = base_score * comp_factor * bonus_multiplier * 1000.0
